...
@Composable
fun SectionUsageDistributionChart(
    analysis: List<SectionUsage>
) {
    val chartEntryData = analysis.mapIndexed { index, sectionUsage ->
        Pair(index.toFloat(), sectionUsage.totalAssessments.toFloat())
    }.toTypedArray()
